            ...
            <Row className="align-items-center">
                <div className="col-12 col-md-8">
                    <div className="position-relative rounded overflow-hidden text-right shadow-sm">
                        {/* Background */}
                        {/* <img className="img-fluid hover-zoom" src={require(`../../assets/images/product-ad/01.jpg`).default} alt="" /> */}
                        {/* Body */}
                ...
                <div className="col-12 col-md-4 mt-5 mt-md-0">
                    <div className="position-relative rounded overflow-hidden">
                        {/* Background */}
                        {/* <img className="img-fluid w-100 hover-zoom" src={require(`../../assets/images/product-ad/02.jpg`).default} alt="" /> */}
                        {/* Body */}
                    ...
                    <div className="position-relative rounded overflow-hidden mt-5 shadow-sm">
                        {/* Background */}
                        {/* <img className="img-fluid w-100 hover-zoom" src={require(`../../assets/images/product-ad/03.jpg`).default} alt="" /> */}
                        {/* Body */}
                        <div className="position-absolute top-50 pl-5">
