        ...
        return (
            <section className="banner pos-r p-0">
                 <OwlCarousel
                  ...
                  >
                    <div className="item bg-pos-rt"  style={{ backgroundImage: `url(${require(`../../assets/images/bg/01.jpg`).default})` }}>
                    ...
                    <div className="item bg-pos-rt"   style={{ backgroundImage: `url(${require(`../../assets/images/bg/02.jpg`).default})` }} >
                        <Container className="h-100">
                            <Row className="h-100 align-items-center">
                                <div className="col-lg-7 col-md-12 custom-py-1 position-relative z-index-1">
